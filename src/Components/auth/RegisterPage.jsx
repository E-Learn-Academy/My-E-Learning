      ...
      <div className="w-full max-w-lg px-8 py-10 mx-4 bg-[#2c2d5c] rounded-lg shadow-2xl">
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="relative">
              ...
              <input id="fullName" type="text" placeholder="Full Name" value={formData.fullName} onChange={handleChange} 
                     ...
                     className="w-full pl-10 pr-3 py-3 bg-gray-700/50 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-[#e85a4f] focus:border-transparent transition duration-300" required />
            </div>
            ...
            <div className="relative">
              ...
              <input id="phoneNumber" type="tel" placeholder="Phone Number" value={formData.phoneNumber} onChange={handleChange} 
                     className="w-full pl-10 pr-3 py-3 bg-gray-700/50 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-[#e85a4f] focus:border-transparent transition duration-300" required />
            </div>
            ...
            <div className="relative">
              ...
              <input id="classLevel" type="text" placeholder="Class Level" value={formData.classLevel} onChange={handleChange} 
                     className="w-full pl-10 pr-3 py-3 bg-gray-700/50 border border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-[#e85a4f] focus:border-transparent transition duration-300" required />
            </div>
          ...
          <div className="mt-8 mb-6">
            ...
            <button type="submit" disabled={loading} className="w-full bg-[#e85a4f] hover:bg-[#d94a3f] text-white font-bold py-3 px-4 cursor-pointer rounded-md focus:outline-none focus:shadow-outline transition duration-300 disabled:bg-[#e85a4f]/50 disabled:cursor-not-allowed flex items-center justify-center">
              {loading ? (
